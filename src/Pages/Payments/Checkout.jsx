...
function Checkout() {
  ...
  toast.error(res?.payload?.message || "Payment verification failed");
  navigate("/checkout/fail");
}
  ...
  return (
    <HomeLayout>
      ...
      >
        <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
          <h1 className="bg-yellow-500 absolute top-0 w-full text-center py-4 text-2xl font-bold rounded-sm">
            Subscription Bundle
          </h1>
          <div className="px-4 space-y-5 text-center">
            <p className="text-[17px]">
              This purchase will give you access to all the courses available on our
            ...
            <button
              type="submit"
              className="bg-yellow-500 text-white font-bold text-lg px-6 py-3 rounded-md hover:bg-yellow-600 transition-all ease-in-out duration-300"
            >
              Buy Now
            </button>
          </div>
